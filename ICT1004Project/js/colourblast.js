...
(function (window) {
    ...
    var leftbutton = document.getElementById("keyLeft");
    var rightbutton = document.getElementById("keyRight");
    ...
    function addleftbuttonlistener(colourbutton) {
        ...
        colourbutton.addEventListener("touchstart", leftbuttondown);
        colourbutton.addEventListener("touchend", leftbuttonup);
    }
    ;

    function addrightbuttonlistener(colourbutton) {
        colourbutton.addEventListener("mousedown", rightbuttondown);
        colourbutton.addEventListener("mouseup", rightbuttonup);
        colourbutton.addEventListener("touchstart", rightbuttondown);
